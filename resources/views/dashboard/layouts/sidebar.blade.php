            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    ...
                    <ul data-submenu-title="Start">
                        <li>
                            <a href="{{ url('profile') }}">
                                <i class="icon-material-outline-settings"></i> Профиль
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('ownProducts.index') }}">
                                <i class="icon-material-outline-dashboard"></i> Товары
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('rkps.index') }}">
                                <i class="icon-material-outline-account-balance"></i> Банковские счета
                            </a>
                        </li>
                        <li>
                    ...
                    <ul data-submenu-title="Organize and Manage">
                        <li>
                            <a href="#">
                                <i class="icon-material-outline-business-center"></i> Jobs
                            </a>
                            <ul>
                                <li>
